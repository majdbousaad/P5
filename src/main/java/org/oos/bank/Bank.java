...
public interface Bank {
     ...
     * @throws AccountDoesNotExistException    if a transfer to a not existing account is to be added
     */
    void createAccount(String account, List<Transaction> transactions, boolean fromFile)
     ...
     * @throws TransactionAttributeException if an attribute check fails
     */
    void removeTransaction(String account, Transaction transaction)
            throws AccountDoesNotExistException, TransactionDoesNotExistException, TransactionAttributeException;
     ...
     * @return true if transaction in the specified account, false otherwise
     */
     ...
     * @throws AccountDoesNotExistException wenn account nicht existiert
     */
